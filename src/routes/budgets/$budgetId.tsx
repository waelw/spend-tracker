...
function BudgetDetail() {
  ...
  const dailyLimit = useQuery(api.budgets.getDailyLimit, {
    budgetId: budgetId as Id<"budgets">,
    clientToday,
  });
  const dailyBreakdown = useQuery(api.budgets.getDailyBreakdown, {
    budgetId: budgetId as Id<"budgets">,
    clientToday,
  });
  ...
  const expenses = useQuery(api.expenses.listByBudget, {
    ...
    startDate: expenseFilters.startDate
      ? parseLocalDate(expenseFilters.startDate).getTime()
      : undefined,
    endDate: expenseFilters.endDate
      ...
      : undefined,
    minAmount: expenseFilters.minAmount
      ? parseFloat(expenseFilters.minAmount)
      : undefined,
    maxAmount: expenseFilters.maxAmount
      ? parseFloat(expenseFilters.maxAmount)
      : undefined,
  ...
  const incomeList = useQuery(api.income.listByBudget, {
    ...
    startDate: incomeFilters.startDate
      ? parseLocalDate(incomeFilters.startDate).getTime()
      : undefined,
    endDate: incomeFilters.endDate
      ...
      : undefined,
    minAmount: incomeFilters.minAmount
      ? parseFloat(incomeFilters.minAmount)
      : undefined,
    maxAmount: incomeFilters.maxAmount
      ? parseFloat(incomeFilters.maxAmount)
      : undefined,
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            {isEditingName ? (
              ...
              <h1
                className="md:text-2xl text-sm font-bold cursor-pointer hover:text-primary transition-colors"
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Are you sure you want to delete this budget? This will also
                  delete all associated currencies and expenses. This action
                  cannot be undone.
                </DialogDescription>
              </DialogHeader>
              <DialogFooter>
              ...
              <Dialog>
                ...
                <DialogContent>
                  <DialogHeader>
                    <DialogTitle>Delete Budget</DialogTitle>
                    <DialogDescription>
                      Are you sure you want to delete this budget? This will
                      also delete all associated currencies and expenses. This
              ...
              <CardContent className="text-xs text-muted-foreground">
                ...
                {dailyLimit.savingsFromPreviousDays > 0 && (
                  <span className="text-green-600 dark:text-green-400">
                    ...
                    (+
                    {formatCurrency(
                      dailyLimit.savingsFromPreviousDays,
                      dailyLimit.mainCurrency,
                    )}{" "}
                    rollover)
                  </span>
                ...
                {dailyLimit.savingsFromPreviousDays < 0 && (
                  <span className="text-destructive">
                    ...
                    (
                    {formatCurrency(
                      Math.abs(dailyLimit.savingsFromPreviousDays),
                      dailyLimit.mainCurrency,
                    )}{" "}
                    overspent)
                  </span>
              ...
              <div className="space-y-2">
                  ...
                  <span>
                    {(
                      (dailyLimit.totalSpent /
                        dailyLimit.effectiveTotalBudget) *
                      100
                    ).toFixed(1)}
                    % spent
                  </span>
                ...
                <div className="h-3 bg-secondary rounded-full overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${Math.min(100, (dailyLimit.totalSpent / dailyLimit.effectiveTotalBudget) * 100)}%`,
                    }}
                  />
                </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <CardDescription>
                    Your available balance in each currency
                  </CardDescription>
                </div>
              </div>
              {currencies.length > 1 && (
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription className="text-xs md:text-base">
              Track how your balance changes with expenses and income
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="h-72">
                    ...
                    const chartData = dailyBreakdown.days
                      ...
                      .map((d, index) => {
                        ...
                        const expectedBalance =
                          dailyLimit.effectiveTotalBudget -
                          dailyBreakdown.baseDailyLimit * (index + 1);
                      ...
                      if (active && payload && payload.length) {
                        ...
                        return (
                          <div className="bg-popover border rounded-lg shadow-lg p-3 space-y-1">
                            ...
                            <p
                              className={`text-sm font-medium ${diff >= 0 ? "text-green-600" : "text-destructive"}`}
                            >
                              {diff >= 0 ? "+" : ""}
                              {formatCurrency(
                                diff,
      ...
      {dailyBreakdown && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Day-by-day spending limits with rollover. Base daily limit:{" "}
              {formatCurrency(
                dailyBreakdown.baseDailyLimit,
                dailyBreakdown.mainCurrency,
              )}
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-2 max-h-96 overflow-y-auto">
              {dailyBreakdown.days.map((day) => (
                <div
                  key={day.date}
                  className={`md:p-3 p-2 rounded-lg border ${
                    day.isToday
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <div className="text-xs font-medium">
                        ...
                        {day.dailyLimitSecondary !== null &&
                          dailyBreakdown.secondaryCurrency && (
                            <span className="text-muted-foreground ml-2">
                              (
                              {formatCurrency(
                                day.dailyLimitSecondary,
                                dailyBreakdown.secondaryCurrency,
                              )}
                              )
                            </span>
                    ...
                    <div className="mt-2 h-1.5 bg-secondary rounded-full overflow-hidden">
                      <div
                        className={`h-full transition-all ${
                          day.spent > day.dailyLimit
                            ? "bg-destructive"
                            : "bg-primary"
                        }`}
                        style={{
                          width: `${Math.min(100, (day.spent / day.dailyLimit) * 100)}%`,
                        }}
                      />
                    </div>
                  )}
      ...
      <div className="flex flex-col gap-6 md:grid grid-cols-2">
              ...
              <div className="flex w-full md:w-auto justify-between items-center gap-2">
                <UpdateRatesButton
                  ...
                  hasNonMainCurrencies={
                    currencies
                      ? currencies.some(
                          (c) => c.currencyCode !== budget.mainCurrency,
                        )
                      : false
                  }
                />
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-sm md:text-base">Add Expense</CardTitle>
          ...
          <CardHeader>
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <CardDescription>
                  Add extra funds to your budget
                </CardDescription>
              </div>
            </div>
          </CardHeader>
            ...
            <div className="flex items-center justify-between flex-wrap gap-2">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <CardDescription>
                    Automatic expenses and income that repeat on a schedule
                  </CardDescription>
                </div>
              </div>
              <AddRecurringItemDialog
            ...
            <div className="flex items-center justify-between flex-wrap gap-2">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <CardDescription>
                    Additional funds added to this budget
                  </CardDescription>
                </div>
              </div>
              <div className="flex items-center gap-2">
